                                    ...
                                    <li class="list-inline-item align-bottom"><a href="javascript:void(0)" <li
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="chat-avtar"><img class="rounded-circle img-fluid wid-40"
                                                        src="{{ asset('assets/images/cs.png') }}" alt="User image"> <i
                                                        class="chat-badge bg-success"></i></div>
                                                <div class="flex-grow-1 mx-3 d-sm-inline-block">
                                                    <h6 class="mb-0">Admin</h6><span
                                                        class="text-sm text-muted">Customer
                                                        Service</span>
                                                </div>
                                            </div>
                                    </li>
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0">
                                                                        <div class="chat-avtar"><img
                                                                                ...
                                                                                src="{{ asset('assets/images/cs.png') }}"
                                                                                alt="User image"> <i
                                                                    ...
                                                                    <div class="flex-grow-1 mx-3">
                                                                        <div
                                                                            ...
                                                                            <p class="mb-1 text-muted">Customer Service
                                                                            </p>
                                                                            <div
                        ...
                        @else
                            <div class="card-footer py-2 px-3">
                                <div class="alert alert-danger" role="alert">
                                    Ticket is Closed, You can <a href="{{ url('ticket/new') }}"
                                        class="alert-link">create a new ticket</a>
                                </div>
                                <hr class="my-2">
                                ...
                                <div class="card">
                                    <div class="text-center card-body position-relative pb-0">
                                        ...
                                        <div class="chat-avtar d-inline-flex mx-auto"><img
                                                ...
                                                src="{{ asset('assets/images/cs.png') }}" alt="User image"></div>
