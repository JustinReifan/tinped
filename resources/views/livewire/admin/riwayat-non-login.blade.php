<div>
    <div class="btn-group flex-wrap mb-3">
        <button wire:click="changeStatus('all')"
            class="btn btn-outline-primary me-2 @if ($status == false) active @endif">Semua</button>
        <button wire:click="changeStatus('pending')"
            class="btn btn-outline-primary me-2 @if ($status == 'pending') active @endif ">Pending</button>
        <button wire:click="changeStatus('processing')"
            class="btn btn-outline-primary me-2 @if ($status == 'processing') active @endif ">Processing</button>

        <button class="btn btn-outline-primary me-2 @if ($status == 'done') active @endif "
            wire:click="changeStatus('done')">Done</button>
        <button class="btn btn-outline-primary me-2 @if ($status == 'error') active @endif "
            wire:click="changeStatus('error')">Error</button>
        <button class="btn btn-outline-primary me-2 @if ($status == 'partial') active @endif "
            wire:click="changeStatus('partial')">Partial</button>
        <button class="btn btn-outline-primary me-2 @if ($status == 'refund') active @endif "
                                    ...
                                    <td>
                                        <div class="btn-group-dropdown">
                                            ...
                                            <ul class="dropdown-menu" style="cursor:pointer">
                                                ...
                                                <li><a class="dropdown-item @if ($row->status == 'process') d-none @endif"
                                                        href="javascript:void(0)"
                                                        wire:click="ubahStatus('process', '{{ $row->id }}')">Processing</a>
                                                </li>
