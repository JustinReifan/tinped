    ...
    <div class="card">
        <div class="card-body">
            <div class="btn-group flex-wrap">
                ...
                <button wire:click="changeStatus('process')"
                    class="btn btn-outline-primary me-2 @if ($status == 'process') active @endif mt-2 ">Processing</button>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @forelse ($history as $row)
                            @if ($row->providers->proses_manual == '0')
                                @php
                                    $row->statusData = [
