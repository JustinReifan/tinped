            ...
            <div class="auth-form">
                <div class="card my-5">
                    <div class="card-body">
                        ...
                        <h5 class="text-center f-w-500 mb-3">Masuk menggunakan username atau email</h5>
                        <form action="{{ url('proses/login') }}" method="POST" autocomplete="off">
                            @csrf
                            ...
                            <div class="d-flex mt-1 justify-content-between align-items-center">
                                ...
                                @endphp
                                <a href="{{ url('/') }}/auth/forgot" class="h6 text-secondary f-w-400 mb-0">Lupa
                                    Password?</a>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function notif() {
            Swal.fire({
                icon: "info",
                title: "Informasi",
                text: "Untuk mengatur ulang kata sandi, silakan hubungi admin.",
            });
        }
