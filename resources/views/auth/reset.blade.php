                ...
                <div class="card my-5">
                    <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                            <p class="text-muted">Password Anda telah berhasil <em><b>direset.</b></em> Silakan buat
                                <em><b>password baru</b></em> Anda untuk melanjutkan.
                            </p>
                        </div>
                        <div class="saprator my-2">
                        </div>
                        <form action="{{ url('proses/reset-password') }}" method="POST" autocomplete="off">
                            @csrf
