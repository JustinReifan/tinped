...
<body data-pc-theme_contrast="true" data-pc-sidebar-caption="true" data-pc-preset="preset-1" data-pc-direction="ltr"
                ...
                <div class="card my-5">
                    <div class="card-body">
                        <div class="text-center">
                            <a href="{{ url('/') }}/"
                                class="fs-3 text-primary fw-bolder">{{ $config->name_panel }}</a>
                            <div class="d-grid my-3">
                                <button type="button" onclick="goAuth('google')"
                                    class="btn d-flex justify-content-center btn mt-2 btn-light-primary bg-light text-muted">
                                    <img src="{{ asset('assets/images/authentication/google.svg') }}" class="me-2"
                                        height="20" alt="img">
                        ...
                        @endif
                        <form action="{{ url('proses/register') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="form-group mb-3">
                                <label class="form-label">Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" name="email" placeholder="Email"
                                    value="{{ $cookie['1'] ?? null != null ? $cookie['1'] : old('email') }}">
                                @error('email')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="full_name"
                                    ...
                                    value="{{ $cookie['0'] ?? null != null ? $cookie['0'] : old('full_name') }}">
                                @error('full_name')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="whatsapp" placeholder="628xxx"
                                        value="{{ old('whatsapp') }}">
                                </div>
                                @error('whatsapp')
                                    <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="d-flex mt-1 justify-content-between align-items-center">
                                <div class="form-check">
                                    <input class="form-check-input input-primary" type="checkbox" name="tos"
                                        id="tos">
                                    <label class="form-check-label text-muted" for="tos">Saya setuju dengan <a
                                            href="javascript:;" onclick="tos();">Ketentuan Layanan</a></label>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer py-2">
                    <a href="javascript:;" class="btn btn-primary float-end" id="agree"><i
                            class="fas fa-thumbs-up fs-6 me-2"></i>Saya Setuju</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function goAuth(provider) {
            window.location.href = '{{ url('auth') }}/' + provider + '/redirect/register';
        }
    </script>
