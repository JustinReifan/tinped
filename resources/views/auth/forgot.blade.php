                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <div class="my-3 text-center">
                                <p class="text-muted">Pastikan <em><b>email</b></em> atau <em><b>whatsapp</b></em> pada
                                    akun
                                    Anda aktif.</p>
                            </div>
                            <form action="{{ url('proses-forgot') }}" method="POST" autocomplete="off">
                            ...
                            <div class="d-flex justify-content-between align-items-end mt-3">
                                <a href="{{ url('/') }}/auth/login" class="link-primary">Masuk</a>
                                <a href="{{ url('/') }}/auth/register" class="link-primary">Daftar</a>
                            </div>
                        </div>
                    </div>
                </div>
