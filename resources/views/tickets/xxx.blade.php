...
<head>
    <title>Detail Invoice | Able Pro Dashboard Template</title><!-- [Meta] -->
    <meta charset="utf-8">
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">Carson Darrin 🖖</h6><span><a
                                                    ...
                                                    data-cfemail="1f7c7e6d6c7071317b7e6d6d76715f7c70726f7e7166317670">[email&#160;protected]</a></span>
                                        </div>
                                    </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <p class="text-muted">Able Pro is completely renowed with high aesthetics User Interface.</p><img
                        src="../assets/images/layout/img-announcement-1.png" alt="img"
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <p class="text-muted">Do you know Able Pro is one of the featured dashboard template selected by
                        Themeforest team.?</p><img src="../assets/images/layout/img-announcement-3.png"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3">
                                    ...
                                    <div class="row align-items-center g-3">
                                        <div class="col-sm-6">
                                            <div class="d-flex align-items-center mb-2"><img
                                                    src="../assets/images/logo-dark.svg" class="img-fluid"
                                                    alt="images"> <span
                                                    class="badge bg-light-secondary rounded-pill ms-2">Paid</span>
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="border rounded p-3">
                                        ...
                                        <p class="mb-0"><a href="/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="ef8d9d8e818b8081dfd8af9f868a9d8c8ac18c8082">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="border rounded p-3">
                                        ...
                                        <p class="mb-0"><a href="/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="7813190b19161c0a19561b171616381a170a1d0a561b1715">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12 text-end d-print-none"><button
                                        class="btn btn-outline-secondary btn-print-invoice">Download</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="theme-main-layout d-flex align-center gap-1 w-100"><a href="#!"
                                ...
                                title="Compact" data-value="compact"><img
                                    ...
                                    class="img-fluid"> </a><a href="#!" data-bs-toggle="tooltip"
                                title="Tab" data-value="tab"><img src="../assets/images/customizer/tab.svg"
                            ...
                            <div class="row theme-color theme-direction">
                                ...
                                <div class="col-6">
                                    <div class="d-grid"><button class="preset-btn btn-img btn" data-value="true"
                                            ...
                                            title="RTL"><img src="../assets/images/customizer/rtl.svg"
                                                alt="img" class="img-fluid"></button></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row theme-color theme-container">
                                ...
                                <div class="col-6">
                                    <div class="d-grid"><button class="preset-btn btn-img btn" data-value="true"
                                            ...
                                            title="Fixed Width"><img src="../assets/images/customizer/fixed.svg"
                                                alt="img" class="img-fluid"></button></div>
                                </div>
                            </div>
                        </div>
