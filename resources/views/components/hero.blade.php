...
<div class="tw-min-h-screen tw-relative tw-overflow-hidden tw-flex tw-flex-col tw-items-center tw-justify-center tw-px-4 sm:tw-px-6 lg:tw-px-12 tw-pt-16 sm:tw-pt-20 tw-pb-8 sm:tw-pb-10" data-aos="fade-up">
    ...
    <div class="tw-max-w-7xl tw-mx-auto tw-flex tw-flex-col tw-items-center tw-justify-center tw-relative tw-z-10 tw-pt-8 sm:tw-pt-12 md:tw-pt-16">
        ...
        <div class="tw-w-full tw-overflow-hidden" data-aos="fade-up" data-aos-delay="600">
            <x-logo-carousel />
        </div>
    </div>
</div>
