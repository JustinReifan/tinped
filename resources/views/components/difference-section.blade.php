...
<section class="tw-w-full tw-py-20 tw-px-6 lg:tw-px-12 tw-relative tw-overflow-hidden" data-aos="fade-up" data-aos-duration="800">
    ...
    <div class="tw-max-w-7xl tw-mx-auto">
        <div class="tw-flex tw-flex-col tw-items-center tw-mb-14" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
            <!-- Section Badge -->
        ...
        <div class="tw-relative tw-group" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            ...
            <div class="tw-bg-white tw-rounded-xl tw-shadow-lg tw-border tw-border-primary-100 tw-overflow-hidden tw-relative tw-z-10">
                ...
                <!-- Responsive container for table body with horizontal scroll on mobile -->
                <div class="tw-overflow-x-auto md:tw-overflow-visible tw-scrollbar-thin tw-scrollbar-thumb-primary-200 tw-scrollbar-track-gray-100">
                    <!-- Comparison Rows -->
