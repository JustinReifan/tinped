...
<section class="tw-w-full tw-py-20 tw-px-6 lg:tw-px-12 tw-relative tw-overflow-hidden" data-aos="fade-up" data-aos-duration="800">
    <!-- Background Elements -->
    ...
    <div class="tw-max-w-7xl tw-mx-auto">
        ...
        <div class="tw-relative tw-group">
            ...
            <div class="tw-bg-white tw-rounded-xl tw-shadow-lg tw-border tw-border-primary-100 tw-overflow-hidden tw-relative tw-z-10">
                ...
                <div class="tw-overflow-x-auto tw-scrollbar-thin tw-scrollbar-thumb-primary-200 tw-scrollbar-track-gray-100">
                    <!-- Comparison Rows -->
                    <div class="tw-divide-y tw-divide-gray-200 tw-min-w-full">
                        @php
                        $comparisonPoints = [
                            [
                        ...
                        <div class="tw-grid tw-grid-cols-3 tw-gap-0 hover:tw-bg-gray-50 tw-transition-colors tw-duration-200" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                            ...
                            <div class="tw-py-4 tw-px-6 tw-text-gray-700 tw-flex tw-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="tw-text-green-500 tw-w-5 tw-h-5 tw-flex-shrink-0 tw-mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                            ...
                            <div class="tw-py-4 tw-px-6 tw-text-gray-700 tw-flex tw-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="tw-text-red-500 tw-w-5 tw-h-5 tw-flex-shrink-0 tw-mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
