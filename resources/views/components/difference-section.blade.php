...
<section class="tw-w-full tw-py-20 tw-px-6 lg:tw-px-12 tw-relative tw-overflow-hidden">
    ...
    <div class="tw-max-w-7xl tw-mx-auto">
        ...
        <div class="tw-relative tw-group">
            ...
            <div class="tw-overflow-x-auto tw-w-full tw-px-0 sm:tw-px-4 tw-overscroll-x-contain tw-pb-2">
                <!-- Table with minimum width to ensure it's scrollable on mobile -->
                <div class="tw-min-w-[640px]">
                    <!-- Card content -->
                    <div class="tw-bg-white tw-rounded-xl tw-shadow-lg tw-border tw-border-primary-100 tw-overflow-hidden tw-relative tw-z-10">
                        ...
                        <div class="tw-grid tw-grid-cols-3 tw-gap-0 tw-bg-gray-50 tw-border-b tw-border-gray-200 tw-sticky tw-top-0">
                ...
                <div class="tw-flex tw-justify-center tw-mt-2 sm:tw-hidden">
                    <span class="tw-text-xs tw-text-gray-500 tw-italic">Swipe to see more →</span>
                </div>
            </div>
        </div>
    </div>
