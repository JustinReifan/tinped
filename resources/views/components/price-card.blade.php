...
<div class="tw-flex tw-flex-row tw-items-center tw-justify-between tw-bg-white tw-rounded-xl tw-p-6 tw-shadow-sm hover:tw-shadow-glow-primary tw-border tw-border-primary-100 hover:tw-border-primary-300 tw-transition-all tw-duration-300 tw-w-[300px] sm:tw-w-[350px]">
    ...
    <div class="tw-flex tw-items-center tw-space-x-3 tw-flex-1">
        ...
        <div class="tw-w-12 tw-h-12 tw-flex tw-items-center tw-justify-center tw-rounded-full tw-bg-primary-100">
            <span class="tw-text-primary-600">
                <x-dynamic-component :component="'social-icons.' . $service['icon']" class="tw-w-6 tw-h-6" />
            </span>
        </div>
        
        <!-- Service Name -->
        <div>
            <h3 class="tw-font-semibold tw-text-gray-900">{{ $service['name'] }}</h3>
            <p class="tw-text-sm tw-text-gray-500">Services</p>
        </div>
    </div>
